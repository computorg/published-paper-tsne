...
figlist <- plot_dataset("compute/mnist6000",methods)
figlist[[1]]
figlist[[2]]
figlist[[3]]
figlist[[4]]
...
figlist <- plot_dataset("compute/olivetti",methods)
figlist[[1]]
figlist[[2]]
figlist[[3]]
figlist[[4]]
...
figlist <- plot_dataset("compute/mnistlarge", c("tsne"))
figlist[[1]]
```

:::{ .content-visible when-format="html"}
```{r}
#| label: fig-random-walk-tsne3d
#| fig-cap: "Visualization of 6,000 digits from the MNIST data set produced by the random walk version of t-SNE (employing all 60,000 digit images)."
#| error: false
#| message: false

figlist <- plot_dataset("compute/mnistlarge", c("tsne3d"))
figlist[[1]]
```
:::
