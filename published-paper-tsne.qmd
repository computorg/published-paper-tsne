...
plot_dataset("compute/mnist", methods = ["tsne"], sample_size=6000)
```

::: {#fig-random-walk-tsne} 

![Visualization of 6,000 digits from the MNIST data set produced by the random walk version of t-SNE (employing all 60,000 digit images).](figures/random-walk-tSNE.png)
